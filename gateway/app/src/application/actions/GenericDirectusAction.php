...
class GenericDirectusAction extends AbstractAction
{
    private \GuzzleHttp\Client $directus_client;

    public function __construct(\GuzzleHttp\Client $directus_client)
    {
    ...
    public function __invoke(ServerRequestInterface $rq, ResponseInterface $rs, array $args): ResponseInterface
    {
        ...
        try {
            return $this->directus_client->request($method, $path, $options);
