...
class GenericGeoquizzAction extends AbstractAction
{
    private \GuzzleHttp\Client $geoquizz_client;

    public function __construct(\GuzzleHttp\Client $geoquizz_client)
    {
        $this->geoquizz_client = $geoquizz_client;
    }
    ...
    public function __invoke(ServerRequestInterface $rq, ResponseInterface $rs, array $args): ResponseInterface
    {
        ...
        try {
            return $this->geoquizz_client->request($method, $path, $options);
